...
function Parallax() {
  const [background, setBackground] = useState(40);
    ...
    <div className="parallax-outer">
      ...
      >
        <img
          ...
          alt="m3"
          src="/img/mountain-3.svg"
        />
        <img
          ref={mountain2}
          className="mountain-2"
          alt="m2"
          src="/img/mountain-2.svg"
        />
        <img
          ref={mountain1}
          className="mountain-1"
          alt="m1"
          src="/img/mountain-1.svg"
        />
        <img ref={sun} className="sun" alt="sun" src="/img/sun.svg" />
        <img
          ref={cloudsBottom}
          className="clouds-bottom"
          alt="clouds-bottom"
          src="/img/clouds-bottom.svg"
        />
        <img
          ref={cloudsLeft}
          className="clouds-left"
          alt="clouds-left"
          src="/img/clouds-left.svg"
        />
        <img
          ref={cloudsRight}
          className="clouds-right"
          alt="clouds-right"
          src="/img/clouds-right.svg"
        />
        <img ref={stars} className="stars" alt="stars" src="/img/stars.svg" />
